...
const Form = ({ handleCloseModal, isOpen, editData }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    payload.append("categoryId", formInput.categoryId);
  ...
  useEffect(() => {
    ...
    if (editData) {
      const { image, name, categoryId, description } = editData;
      setFormInput({ image, name, categoryId, description });
    }
  }, [editData, dispatch]);
        ...
        <div className="pb-10 w-96 sm:w-2/3 md:w-1/2 h-full overflow-auto xl:w-1/3 p-4 bg-secondary shadow-xl">
          ...
          <div className="flex justify-between items-center">
            <span className="text-color">
              {editData ? "Update" : "Add"} Sub Category
            </span>
            <MdClose
          ...
          <form onSubmit={handleSubmit} className="mt-5 grid gap-3">
            ...
            <div className="grid gap-1">
              ...
              <ShowError data={errors.categoryId} />
            </div>
