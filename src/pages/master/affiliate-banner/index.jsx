...
const AffiliateBanners = () => {
  ...
  const { affilliateBanner, fetchLoad, loading } = useSelector(
  ...
  const handleDeleteService = async () => {
    const response = await dispatch(removeAffilliateBanner(editData._id));
  ...
  const totalItems = affilliateBanner?.length;
        ...
        <div className="rounded text-left whitespace-no-wrap w-full border overflow-auto">
          <table className="table-auto divide-y whitespace-nowrap w-full text-left">
            ...
            <tbody className="divide-y">
              {affilliateBanner?.slice(trimStart, trimEnd).map((item) => {
                return (
...
export default Layout(AffiliateBanners);
